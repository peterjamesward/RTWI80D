...
var $author$project$MapPortController$newTrackRendering = function (data) {
	return $author$project$MapPortController$mapCommands(
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
...
var $author$project$DomainModel$mostEasterly = function (treeNode) {
...
var $author$project$DomainModel$mostWesterly = function (treeNode) {
	return $ianmackenzie$elm_geometry$Direction2d$toAngle(
		A2(
			$ianmackenzie$elm_geometry$Direction2d$rotateBy,
...
var $author$project$SceneBuilderMap$useBounds = F5(
	function (minLon, maxLon, minLat, maxLat, track) {
		var westernEdge = $ianmackenzie$elm_units$Angle$degrees(maxLon);
		var mapLocation = function (point) {
			var _v7 = point;
			var longitude = _v7.longitude;
			var latitude = _v7.latitude;
			var altitude = _v7.altitude;
			return _Utils_Tuple2(
				$ianmackenzie$elm_geometry$Direction2d$toAngle(longitude),
				latitude);
		};
				...
				if (_v0.b.$ === 'Just') {
					switch (_v0.a.$) {
						...
						case 'SetBounds':
							...
							var maxLat = _v2.d;
							var track = _v0.b.a;
							return $author$project$MapPortController$newTrackRendering(
								A5($author$project$SceneBuilderMap$useBounds, minLon, maxLon, minLat, maxLat, track));
						default:
							break _v0$3;
					}
				} else {
