...
var $author$project$MapPortController$MapInfo = F3(
	function (mapZoom, centreLon, centreLat) {
		return {centreLat: centreLat, centreLon: centreLon, mapZoom: mapZoom};
	});
var $author$project$MapPortController$defaultMapInfo = A3($author$project$MapPortController$MapInfo, 0.0, 0.0, 0.0);
...
var $author$project$ToolsController$defaultTools = _List_fromArray(
	[$author$project$ToolsController$trackInfoBox]);
var $author$project$ToolsController$defaultOptions = {tools: $author$project$ToolsController$defaultTools};
...
var $author$project$Main$init = _Utils_Tuple2(
	{
		...
		viewMode: $author$project$ViewContext$ViewMap,
	...
	$elm$core$Platform$Cmd$batch(
		_List_fromArray(
			[
				...
				$author$project$MapPortController$createMap($author$project$MapPortController$defaultMapInfo)
			])));
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2($elm$core$Basics$composeL, $author$project$Main$MapPortsMessage, $author$project$MapPortController$MapPortMessage)),
...
var $author$project$Main$outputGPX = function (model) {
		...
		if (_v0.$ === 'Just') {
			...
			return _Utils_ap(
				...
				(!A2(
					...
					'.CBOR',
					$elm$core$String$toUpper(filename))) ? '.cbor' : '');
		} else {
			return 'NOFILENAME';
		}
	}();
	var cborString = A2(
		...
		'Sorry, nothing to write.',
		A2(
			$elm$core$Maybe$map,
			$elm$core$Basics$always('WRITE CBOR HERE'),
			model.track));
	return A3($elm$file$File$Download$string, outputFilename, 'binary', cborString);
};
					...
					if (_v0.b.$ === 'Just') {
						switch (_v0.a.$) {
							...
							case 'SetBounds':
								...
								return _Utils_update(
									mdl,
									{maxLat: maxLat, maxLon: maxLon, minLat: minLat, minLon: minLon});
							default:
								break _v0$2;
						}
					} else {
		...
		var refreshOpenTool = F2(
			function (entry, _v1) {
				...
				if (_Utils_eq(entry.state, $author$project$ToolsController$Expanded)) {
					var _v0 = A4($author$project$ToolsController$toolStateHasChanged, entry.toolType, $author$project$ToolsController$Expanded, isTrack, updatedModel);
...
var $author$project$Actions$SetBounds = F4(
	function (a, b, c, d) {
		return {$: 'SetBounds', a: a, b: b, c: c, d: d};
	});
				...
				switch (jsonMsg.a) {
					case 'click':
						...
						if ((_v1.a.$ === 'Ok') && (_v1.b.$ === 'Ok')) {
							...
							return _List_fromArray(
								[
									$author$project$Actions$SetCurrent(index)
								]);
						} else {
							return _List_Nil;
						}
					case 'bounds':
						...
						var _v2 = _Utils_Tuple2(
							_Utils_Tuple2(minLon, maxLon),
							_Utils_Tuple2(minLat, maxLat));
						if ((((_v2.a.a.$ === 'Ok') && (_v2.a.b.$ === 'Ok')) && (_v2.b.a.$ === 'Ok')) && (_v2.b.b.$ === 'Ok')) {
							var _v3 = _v2.a;
							var aMinLon = _v3.a.a;
							var aMaxLon = _v3.b.a;
							var _v4 = _v2.b;
							...
							return _List_fromArray(
								[
									A4($author$project$Actions$SetBounds, aMinLon, aMaxLon, aMinLat, aMaxLat)
								]);
						} else {
							return _List_Nil;
						}
		...
		switch (msg.$) {
			...
			case 'GpxLoaded':
				...
				if (trackTree.$ === 'Just') {
					...
					var _v3 = A2($author$project$ToolsController$refreshOpenTools, modelWithTrack.track, modelWithTrack.toolOptions);
			...
			case 'SetViewMode':
				...
				if (_v6.$ === 'Just') {
					...
					return _Utils_Tuple2(
						newModel,
						$author$project$Main$showTrackOnMapCentered(track));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'Resize':
			...
			case 'ToolsMsg':
				var toolMsg = msg.a;
				var _v8 = A4($author$project$ToolsController$update, toolMsg, model.track, $author$project$Main$ToolsMsg, model.toolOptions);
	...
	var slider = function (trackLength) {
		return A2(
			...
			$author$project$ViewPureStyles$wideSliderStyles,
			{
				...
				max: trackLength - 1,
				min: 0,
				onChange: A2($elm$core$Basics$composeR, $elm$core$Basics$round, $author$project$Main$SetCurrentPosition),
...
var $author$project$Main$SaveCBOR = {$: 'SaveCBOR'};
...
var $author$project$Main$topLoadingBar = function (model) {
	var saveCBOR = A2(
		...
		{
			label: $mdgriffith$elm_ui$Element$text('Save as CBOR'),
			onPress: $elm$core$Maybe$Just($author$project$Main$SaveCBOR)
		});
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			...
			])))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"Time.Era":{"args":[],"type":"{ start : Basics.Int, offset : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GpxRequested":[],"GpxSelected":["File.File"],"GpxLoaded":["String.String"],"AdjustTimeZone":["Time.Zone"],"SetRenderDepth":["Basics.Int"],"SetCurrentPosition":["Basics.Int"],"SetViewMode":["ViewContext.ViewMode"],"MapPortsMessage":["MapPortController.MapMsg"],"Resize":["Basics.Int","Basics.Int"],"GotWindowSize":["Result.Result Browser.Dom.Error Browser.Dom.Viewport"],"ToolsMsg":["ToolsController.ToolMsg"],"SaveCBOR":[]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"File.File":{"args":[],"tags":{"File":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"MapPortController.MapMsg":{"args":[],"tags":{"MapPortMessage":["Json.Encode.Value"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"ToolsController.ToolMsg":{"args":[],"tags":{"ToolStateToggle":["ToolsController.ToolType","ToolsController.ToolState"],"ToolNoOp":[]}},"ViewContext.ViewMode":{"args":[],"tags":{"ViewInfo":[],"ViewMap":[]}},"Time.Zone":{"args":[],"tags":{"Zone":["Basics.Int","List.List Time.Era"]}},"List.List":{"args":["a"],"tags":{}},"ToolsController.ToolState":{"args":[],"tags":{"Expanded":[],"Contracted":[],"Disabled":[]}},"ToolsController.ToolType":{"args":[],"tags":{"ToolTrackInfo":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});}(this));